          ...
          <form onSubmit={handleLogin}>
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setAuthForm({...authForm, username: e.target.value})}
                required
              />
            </div>
            <div className="form-group">
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setAuthForm({...authForm, password_confirm: e.target.value})}
                required
              />
            </div>
                  ...
                  <div>
                    ...
                    <div className="form-group">
                      ...
                      <textarea
                        ...
                        onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setEditForm({...editForm, content: e.target.value})}
                        required
                      />
                    </div>
